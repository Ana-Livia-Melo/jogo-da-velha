...
function salvarNome() {
    var nome = document.getElementById("jogador1");
    var nome2 = document.getElementById("jogador2");
    document.getElementById("nomeJogador1").textContent = nome.value ;
    document.getElementById("nomeJogador2").textContent = nome2.value;

    nome.style.visibility = 'hidden';
    nome2.style.visibility = 'hidden';
}
...
function start(mode) {
  ...
  if (mode == 'cpu')
  {
    localStorage.setItem('starting', 'p');
    
    nome.style.visibility = 'hidden';
    nome2.style.visibility = 'hidden';
    jogador1.style.visibility = 'hidden';
    jogador2.style.visibility = 'hidden';
